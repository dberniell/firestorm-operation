 ...
 */
final class Version20190929181832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE areas (uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', area VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', weather_wind VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, weather_humidity VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, natural_natural VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
